...
{
//    NSString *url = [NSString stringWithFormat:@"http://api.flickr.com/services/rest/?method=flickr.photos.search&license=1,2,4,7&has_geo=1&extras=original_format,description,geo,date_upload,owner_name&api_key=%@", FlickrAPIKey];
    
//    NSString *url = [NSString stringWithFormat:@"https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=9e727ec8b24c10431e696a26db191800&license=1%2C2%2C4%2C7&has_geo=1&extras=original_format,description,geo,date_upload,owner_name&format=json&nojsoncallback=1"];
   
//    NSString *url = [NSString stringWithFormat:@"https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=9e727ec8b24c10431e696a26db191800&license=1%2C2%2C4%2C7&has_geo=1&extras=&format=json&nojsoncallback=1&auth_token=72157645126466159-49995b18c0ce2035&api_sig=ec6b29c6cf909c4d07f27c6666f02268"];
    
//    return [self URLForQuery:url];
